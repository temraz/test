...
<html lang="en-US">
  ...
  <tr>
    <td><a href="<?php echo base_url();?>site/build_tree/"><p class="active">Step one </p></a></td>
    <td><a href="<?php echo base_url();?>site/select_job/"><p >Step two </p></a> </td>
  </tr>
</table>
 </div>
            <div id="wrapper" >
                    ...
                    <form id="formElem" name="formElem" action="" method="post">
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                                ...
                                <input id="phone" name="phone" placeholder="day/mon/year" type="tel" AUTOCOMPLETE=OFF />
                            </p>
                        </fieldset>
						...
						<fieldset class="step">
                            ...
                            <p class="submit">
                                <button id="registerB" type="submit">Next step</button>
                            </p>
                        </fieldset>
                    </form>
                </div>
